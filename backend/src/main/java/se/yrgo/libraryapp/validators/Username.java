 ...
 * 
 * I.e. no funny characters or whitespace and at least four and no more than 30 characters long.
 */
public final class Username {
    private static Pattern regex = Pattern.compile("[@._a-zA-Z0-9]{4,30}");
